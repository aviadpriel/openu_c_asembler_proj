/*
 =========================================================================================================================================
 ============================= Maman 14 ==================================================================================================
 File Name   : directiveTestfunction.c
 Semester    : 2017b
 Description : collection of functions used in first run.
 =========================================================================================================================================
 */
#include "struct.h"
#include <stdio.h>
...
Input: char *command- .
Return: none.
Description: prints the input of user or a file using linked list.
...
int dataF(char *command, char *label,int *dc, dataList **dataHead, labelsList **labelsHead,int line)
{
  ...
  /*counts commas to identify the number of values need to inserted*/
  while (command[i] != '\0')
  {
    if (command[i] == ',')
    {
  ...
  /*commaList- inserts data values to dataList*/
  if ((commaList(dataHead, command, cummaCounter, dc,line)) == ERROR)
    return ERROR;
  /*if the data is under label- inserts label to labelList*/
  if (label)
  {
